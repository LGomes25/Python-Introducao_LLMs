...
def generate(state: State) -> dict:
    ...
    response = llm_prompt_template.invoke(
        {"pergunta": pergunta, "contexto": docsInfo_content}
    )
...
template = """
Responda a pergunta apenas com base no contexto fornecido. Se a pergunta não puder ser respondida com o contexto, diga que não sabe. Seja amigável e útil.
